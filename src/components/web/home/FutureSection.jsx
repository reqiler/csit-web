  ...
  const fields = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path d="M10 5H7C5.89543 5 5 5.89543 5 7V16H19V11.5" />
          <path d="M15 4L13 6L15 8" />
          <path d="M19 4L21 6L19 8" />
          <path d="M3 16H21V17C21 18.1046 20.1046 19 19 19H5C3.89543 19 3 18.1046 3 17V16Z" />
        </svg>
      ),
    },
    {
      ...
      en: "AI & Data Science",
      icon: (
        <svg className="h-20 w-20 text-blue-600"
          fill="currentColor"
      ...
      <div className="relative max-w-[1400px] mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in-down">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">
            {lang === "th" ? "สาขาวิชาเฉพาะทาง" : "Specialized Fields"}
          </h2>
          <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            {lang === "th"
              ? "สำรวจสาขาวิชาต่างๆ ที่เราเชี่ยวชาญ พร้อมเทคโนโลยีล้ำสมัยและแนวทางการศึกษาที่ทันต่อความต้องการของอุตสาหกรรม"
              : "Explore our specialized fields with cutting-edge technology and education approaches that meet industry demands"
            }
          </p>
          <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full mx-auto mt-6" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
          {fields.map((field, index) => (
            ...
            >
              {/* Card Container */}
              <div className="relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 border border-slate-100 overflow-hidden">
                {/* Background gradient on hover */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                {/* Icon Container */}
                <div className="relative mb-6 flex justify-center">
                  <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center shadow-inner group-hover:shadow-lg transition-all duration-300 group-hover:scale-110">
                    {/* Glow effect */}
                    <div className="absolute -inset-2 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                ...
                <div className="text-center">
                  <h3 className="text-lg font-bold text-slate-900 mb-2 group-hover:text-blue-900 transition-colors duration-300">
                    {lang === "th" ? field.th : field.en}
                  </h3>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    {lang === "th" ? field.en : field.th}
                  </p>
                </div>

                {/* Hover indicator */}
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-8 h-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
            </div>
          ))}
        </div>
